...
const SignInScreen = () => {
    ...
    return (
        <ImageBackground source={images.wallpaper} style={{ flex: 1 }} resizeMode="cover">
            <View className="w-full h-full justify-center items-center">
                ...
                <View
                    className="m-5 rounded-xl w-5/6"
                    style={{
                        shadowOffset: {
                            width: 0,
                            height: 3,
                        ...
                        >
                            ...
                            <View className="justify-center pt-5 flex-row gap-2">
                                ...
                                <TouchableOpacity onPress={() => navigation.navigate('Sign Up')}>
                                    <Text className="text-primary font-semibold">{t('signup')}</Text>
                                </TouchableOpacity>
                            </View>
